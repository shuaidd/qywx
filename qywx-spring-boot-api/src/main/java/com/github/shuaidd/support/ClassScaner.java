...
public class ClassScaner implements ResourceLoaderAware {
    ...
    public static Set<Class> scanForParent(String[] basePackages,Class<?> parent) {
        Set<Class> set = scan(basePackages,null);
        return set.stream().filter(Class::isInterface).collect(Collectors.toSet());
    }
